...
<div id="install">
  Cài đặt phiên bản WebApp để trải nghiệm tốt hơn trên iPhone, chỉ cần bấm vào
  <img id="share" src="data:image/png;base64,${iOSShareBase64}"> và chọn "Thêm vào màn hình chính" (trên Safari).
</div>
